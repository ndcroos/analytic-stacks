...
% 29:16
So this is still a countable limit ($\lambda = \omega$), so it's still light. But obviously it's much bigger than the first example, if you just think in terms of the number of points. So number of points is $\kappa = 2^\omega$.
