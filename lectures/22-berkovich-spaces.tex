...
So Berkovich spaces. Let me start with a reminder on the definition, so we know where we're going. $A, \norm{})$ is a Banach ring. That means that $A$ is a commutative ring, and this norm map $||: A \rightarrow \Rnonneg$ from $A$ to the non-negative real numbers ,satisfies, 
