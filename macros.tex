...
\newcommand{\BerkSpec}{\mathcal{M}} % Berkovich spectrum, todo: clarify difference with Spec^Berk, todo: add argument for this?
\newcommand{\ExtBerkSpec}{ \widetilde{\mathcal{M}} } % Extended Berkovich spectrum
\newcommand{\Loc}{\text{Loc}} % Locale, todo: argument for this?
